...
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1', SYSDATE, 521, 24, 1, NULL);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식1', SYSDATE, 521, 24, 1, 1);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식2', SYSDATE, 521, 24, 1, 1);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3', SYSDATE, 521, 24, 1, 1);

INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2', SYSDATE, 521, 24, 1, NULL);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모3', SYSDATE, 521, 24, 1, NULL);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모4', SYSDATE, 521, 24, 1, NULL);

INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2-자식1', SYSDATE, 521, 24, 1, 5);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2-자식2', SYSDATE, 521, 24, 1, 5);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모2-자식3', SYSDATE, 521, 24, 1, 5);


INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3-손자1', SYSDATE, 521, 24, 1, 4);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3-손자2', SYSDATE, 521, 24, 1, 4);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL, '부모1-자식3-손자3', SYSDATE, 521, 24, 1, 4);
...
FROM 절에 서브쿼리(인라인뷰)를 사용해서 미리 조건에 맞는 형태의 행으로 구성
*/
...
CREATE TABLE CHAT_MESSAGE (
   ...
   CREATE_DT   DATE DEFAULT SYSTIMESTAMP,
...
-- 채팅방 생성
INSERT INTO CHAT_ROOM VALUES(SEQ_CR_NO.NEXTVAL, '테스트1', DEFAULT, 24/*회원번호*/);

-- 채팅방 참여
INSERT INTO CHAT_ROOM_JOIN VALUES(24/*회원번호*/, 1/*채팅방번호*/);
INSERT INTO CHAT_ROOM_JOIN VALUES(1/*회원번호*/, 1/*채팅방번호*/);

-- 채팅방 생성
INSERT INTO CHAT_ROOM VALUES(SEQ_CR_NO.NEXTVAL, '테스트2', DEFAULT, 41/*회원번호*/);

-- 채팅방 참여
INSERT INTO CHAT_ROOM_JOIN VALUES(41/*회원번호*/, 2/*채팅방번호*/);
INSERT INTO CHAT_ROOM_JOIN VALUES(1/*회원번호*/, 2/*채팅방번호*/);
INSERT INTO CHAT_ROOM_JOIN VALUES(24/*회원번호*/, 2/*채팅방번호*/);
...
SELECT CHAT_ROOM_NO, TITLE, MEMBER_NM, (SELECT COUNT(*) FROM CHAT_ROOM_JOIN WHERE CHAT_ROOM_NO = R.CHAT_ROOM_NO) COUNT
FROM CHAT_ROOM R
JOIN MEMBER USING(MEMBER_NO)
WHERE R.STATUS_CD = 1
ORDER BY 1 DESC;
