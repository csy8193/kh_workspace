					...
					<div class="form-inline mb-2">
						...
						<div class="mr-2 boardImg">
							...
							<c:if test="${!empty img1}">
								<a href="${img1}" download="${original1}">다운로드</a>
							</c:if>
						</div>
						...
						<div class="mr-2 boardImg">
							...
							<c:if test="${!empty img2}">
								<a href="${img2}" download="${original2}">다운로드</a>
							</c:if>
						</div>
						...
						<div class="mr-2 boardImg">
							...
							<c:if test="${!empty img3}">
								<a href="${img3}" download="${original3}">다운로드</a>
							</c:if>
						</div>
					</div>
