...
public class Example10 {
	public static void main(String[] args) {
		...
		// radio, checkbox는 clear()불가
		/*
		 * for(WebElement school : schoolList) { school.clear(); }
		 * 
		 * for(WebElement interest : interestList) { interest.clear(); }
		 */
		
		// reset 버튼 클릭
		driver.findElement(By.cssSelector("body > form > fieldset > ul > li:nth-child(10) > button:nth-child(2)")).click();
