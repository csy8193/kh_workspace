...
public class SignUpServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		// HttpServletResponse res : 응답과 관련된 정보, 스트림을 가지고 있는 객체
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		 ...
		 * 
		 * // 1. 응답 화면의 문서 형식 지정 res.setContentType("text/html; charset=UTF-8");
		 * 
		 * // 2. 응답 화면을 클라이언트에게 전달할 통로(스트림) 얻어오기 PrintWriter out = res.getWriter();
		 * 
		 * // 3. 클라이언트에게 응답 화면 코드(HTML) 내보내기(출력) out.print("<!DOCTYPE HTML>");
		 * out.print("<html>"); out.print("<head>");
		 * out.print("<title>회원 가입 결과</title>"); out.print("</head>");
		 * out.print("<body>"); out.print("<h1>"+memberName+"님의 가입을 환영합니다</h1>");
