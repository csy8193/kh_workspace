			...
			<ul class="pagination">
				...
				<c:forEach begin="${pagination.startPage}" end="${pagination.endPage}" step="1" var="i">
					<c:choose>
						...
						<c:otherwise>
							<li><a class="page-link" href="${contextPath}/board/list?cp=${i}">${i}</a></li>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				
				<c:if test="${ pagination.endPage != pagination.maxPage }">
					<li><a class="page-link" href="${contextPath}/board/list?cp=${pagination.nextPage}">&gt;</a></li>
					<li><a class="page-link" href="${contextPath}/board/list?cp=${pagination.maxPage}">&gt;&gt;</a></li>
				</c:if>
			</ul>
		</div>
