...
--%>
	...
	<div class="container"  style="min-height:700px">
		...
		<div class="row my-5">
			...
			<div class="col-sm-8">
				<%-- memberAddress를 ",,"를 기준으로 쪼갠 배열을 저장하는 변수 선언 --%>
				...
				<div class="bg-white rounded shadow-sm container p-3">
					<form method="POST" action="update" onsubmit="return memberUpdateValidate();" class="form-horizontal" role="form">
						...
						<div class="row mb-3 form-row">
							...
							<div class="col-md-6">
								<h5 id="name">${sessionScope.loginMember.memberName } </h5>
							</div>
						</div>
						...
						<div class="row mb-3 form-row">
							...
							<div class="col-md-6">
								<input type="email" class="form-control" id="email" name="email" value="${sessionScope.loginMember.memberEmail }">
							</div>
						</div>
						<br>
