...
public class ReviewService {
	...
	*/
	public void practice2() {
		...
		s1.setStudentId("21001");
		s1.setStudentName("이동준");
		s1.setStudentGrade(1);
		s1.setStudentClass(5);
		s1.setStudentSex('남');
		System.out.println("학생1 : " + s1.toString());
		
		Student s2 = new Student("20345", "김민서", 2, 3, '여');
		System.out.println("학생2 : " + s2.toString());
	...
	*/
	public void practice3() {
		...
		Student s1 = new Student(str, str2, int1, int2, char1);
		
		
		System.out.println("입력 받은 학생 정보 : " + s1.toString());
	...
	*/
	public void practice5() {
		...
		for(int i=0; i < s1.length; i++) {
			...
			s1[i] = new Student(str, str2, int1, int2, char1);
		}
		
		for(int i=0; i< s1.length; i++) {
			System.out.println((i+1)+"번째 학생 : " + s1[i].toString());
		}
